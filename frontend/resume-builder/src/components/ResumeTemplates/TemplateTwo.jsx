...
import WordExperience from "../ResumeSections/WordExperience";
...
const TemplateTwo = ({ containerWidth, resumeData, colorPalette }) => {
  ...
  return (
    ...
    >
          ...
          <div>
            <div className="grid grid-cols-12 gap-2 items-center">
              <div className="col-span-6">
                ...
                <p className="text-[15px] font-semibold m-2">
      ...
      <div className="mx-10 pb-5">
        ...
        <div className="mt-4">
          <Title text="Word Experiance" color={themeColors[1]} />
              ...
              <div className="flex flex-wrap items-center gap-3 mt-4">
                {resumeData.interests.map((interest, index) => {
                  ...
                  return (
                    <div
                      key={`interest_${index}`}
                      className="text-[10px] py-1 px-3 rounded-lg font-medium "
