        ...
        <div className="flex flex-col md:flex-row items-center">
          <div className="w-full md:w-1/2 pr-4 mb-8 md:mb-0">
            ...
            <p className="text-lg text-gray-700 mb-8">
              Craft a standout & professional resume in minutes with our
              intuitive resume builder.
            </p>
            <button
              className="bg-black text-white text-sm font-semibold px-8 py-3 rounded-lg hover:bg-gray-700 transition-colors cursor-pointer "
              onClick={handleCTA}
            >
              Get Started
            </button>
        ...
        <section className="mt-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              <h3 className="text-lg font-black mb-3">Esay Edition</h3>
              <p className="text-gray-600">
                Upload your resume sections with live preview and instant
                formatting.
              </p>
            </div>

            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              <h3 className="text-lg font-black mb-3">Beautiful Templates</h3>
              <p className="text-gray-600">
                Choose from moderen, professional templates that are esay to
                customize.
              </p>
            </div>

            <div className="bg-gray-50 p-6 rounded-xl shadow-sm hover:shadow-md transition">
              <h3 className="text-lg font-black mb-3">One-Click Export</h3>
              <p className="text-gray-600">
                Download your resume in instantly as a high-quality PDF with one
                click.
              </p>
            </div>
          </div>
